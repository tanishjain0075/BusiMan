    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input {...register('sku', { required: 'SKU is required' })} className={inputCls} />
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          ...
          <input type="number" step="0.01" {...register('costPrice', { required: 'Required' })} className={inputCls} />
          {errors.costPrice && <p className={errorCls}>{errors.costPrice.message}</p>}
        </div>
        <div>
          <label className={labelCls}>Selling Price *</label>
          <input type="number" step="0.01" {...register('sellingPrice', { required: 'Required' })} className={inputCls} />
          {errors.sellingPrice && <p className={errorCls}>{errors.sellingPrice.message}</p>}
        </div>
        <div>
          <label className={labelCls}>Quantity *</label>
          <input type="number" {...register('quantity', { required: 'Required' })} className={inputCls} />
